...
disp("script starts (4x4 on subdomain)")
...
for p_counter = 1:4
    ...
    save_pattern_as_dossier_page_pdf(cut_list_min, name_title, "min4x4middle_subdomain", drawBox, subdomain)
...
save("output/4x4subdomain_orientation.mat","save_orientation");

disp("We are done, congrats. Please look at your file min4x4middle_subdomain.pdf")