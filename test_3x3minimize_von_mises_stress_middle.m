...
disp("script starts (3x3 on domain)")
...
for p_counter = 1:4
    ...
    save_pattern_as_dossier_page_pdf(cut_list_min, name_title, "min3x3middle", drawBox, subdomain_to_diplay_normes)
...
save("output/3x3domain_orientation.mat","save_orientation");

disp("We are done, congrats. Please look at your file min3x3middle.pdf")