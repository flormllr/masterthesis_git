...
% plot_cut_list_jpg(cut_list, "Sierpinski curve", "sierpinski_curve");
...
% plot_von_mises_stress_jpg(result, 'von Mises stress: Sierpinski curve', 'sierpinski_curve')
% plot_von_mises_stress_jpg(result, 'von Mises stress (log scale): Sierpinski curve', 'sierpinski_curve_log', true)

% plot_nodes_mesh_highest_von_mises_stress(result, 50);
% plot_nodes_mesh_highest_von_mises_stress_jpg(result, 50, 'Sierpinski curve', 'sierpinski_curve')

% generate_pictures_jpg(cut_list, 'sierpinski_curve');
