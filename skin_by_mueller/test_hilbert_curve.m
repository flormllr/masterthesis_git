...
% plot_cut_list_jpg(cut_list, "Hilbert curve", "hilbert_curve");
...
% plot_von_mises_stress_jpg(result, 'von Mises stress: Hilbert curve', 'hilbert_curve')
% plot_von_mises_stress_jpg(result, 'von Mises stress (log scale): Hilbert curve', 'hilbert_curve_log', true)

% plot_nodes_mesh_highest_von_mises_stress(result, 50);
% plot_nodes_mesh_highest_von_mises_stress_jpg(result, 50, 'Hilbert curve', 'hilbert_curve')

% generate_pictures_jpg(cut_list, 'hilbert_curve');
