...
% plot_cut_list_jpg(cut_list, "shifted lines", "shifted_lines");
...
% plot_von_mises_stress_jpg(result, 'von Mises stress: shifted lines', 'shifted_lines')
% plot_von_mises_stress_jpg(result, 'von Mises stress (log scale): shifted lines', 'shifted_lines_log', true)

% plot_nodes_mesh_highest_von_mises_stress(result, 50);
% plot_nodes_mesh_highest_von_mises_stress_jpg(result, 50, 'shifted lines', 'shifted_lines')

% generate_pictures_jpg(cut_list, 'shifted_lines');
